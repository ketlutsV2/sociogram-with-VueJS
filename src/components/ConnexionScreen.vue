        ...
        <div class="main-reverse flex-rows flex-3">
          <div class="flex-1 flex-columns" id="connexion-menu">
            <div class="btn-group-vertical">
              <button class="btn btn-light" id="connexion-menu-nouvelEtablissement" autocomplete="off" @click="modeDuFormulaire='creation';this.focusInput()"><span class='bi bi-plus'></span> Créer un compte</button> 
            </div>
          </div>
             ...
             <form onsubmit="return false">
              ...
              <div class="form-group">
               <div class="input-group">       
                 ...
                 <input class="form-control" ref='pseudoInput' :value="user_pseudo" @input="setUserPseudo" placeholder="Pseudo" />
               </div>
               <div class="input-group">
                 <div class="input-group-text"><span class="bi bi-chevron-right"></span></div>
                 <input class="form-control" v-model="user_pass_1" placeholder="Mot de passe" type="password"/>
               </div>
               <div class="input-group" id="user_passe2_form" v-if="modeDuFormulaire=='creation'">
                 <div class="input-group-text"><span class="bi bi-chevron-right"></span></div>
               ...
               <div class="flex-rows">
                ...
                <div class="text-end flex-1" v-if="modeDuFormulaire=='connexion'">
                 <div id="connexion-btn-step1">
                   <div class="form-group text-end">
                    <button id="connexion-btn-user" class="btn btn-primary connexion-btn" @click="connexion" data-loading-text="Connexion en cours..." type="submit"><span class='bi bi-box-arrow-in-right'></span> Connexion</button> 
                    <br/>
          ...
          <div id="connexion-btn-step2" class="text-center" v-if="modeDuFormulaire=='creation'">
            <button class="btn btn-light float-left" @click="modeDuFormulaire='connexion'">Annuler</button> 
            <button class="btn btn-primary float-right connexion-btn connexion-requise" onclick="app.connexionValidForm();" ><span class='bi bi-plus'></span> Créer ce compte</button> 
          </div>
        </form>
